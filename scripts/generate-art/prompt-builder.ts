...
/** Composer de prompt em TS — substitui a cadeia de 9 nodes do
 * `ComfyUI-OOP` (`OOPStyleNode`, `OOPViewNode`, `OOPHairNode`, `OOPEyesNode`,
 * `OOPMouthNode`, `OOPClothingNode`, `OOPPoseNode`, `OOPPersonNode`,
 * `OOPNode`) que faziam só isso — tradução enum→texto + concatenação — do
 * lado do ComfyUI. Ver `generate-art-migracao-schema-proprio.md` pro porquê.
 *
