...
/** Insere (ou substitui) `geracaoArt.<gênero>.variantes.<chave>.seed` no texto
 * de um `portrait.json`, devolvendo o texto novo.
 *
...
export function aplicarSeed(textoJson: string, genero: GeneroAlvo, chave: string, seed: number): string {
...
/** Relê o `portrait.json` da espécie e grava nele a seed da variante.
 *
